...
// Generated by ffigen from Tree-sitter's api.h.
...
/// Bindings for Tree-sitter from api.h
class TreeSitterBindings {
  ...
  TreeSitterBindings(ffi.DynamicLibrary dynamicLibrary)
    : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  TreeSitterBindings.fromLookup(
